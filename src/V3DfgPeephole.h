...
#define FOR_EACH_DFG_PEEPHOLE_OPTIMIZATION(macro)   \
    ...
    _FOR_EACH_DFG_PEEPHOLE_OPTIMIZATION_APPLY(macro, REDUCTION_OF_ONE_BIT_CONCAT) \
    ...
    _FOR_EACH_DFG_PEEPHOLE_OPTIMIZATION_APPLY(macro, PUSH_NOT_THROUGH_CONCAT) \
    ...
    _FOR_EACH_DFG_PEEPHOLE_OPTIMIZATION_APPLY(macro, WIDEN_ADD_OPERAND) \
...
#undef OPTIMIZATION_ID
    ...
    bool m_enabled[_ENUM_END];  // Enable flags for each optimization
    VDouble0 m_count[_ENUM_END];  // Count of applications for each optimization
