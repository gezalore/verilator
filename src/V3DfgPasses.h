...
// Attempt to synthesize given DfgAlways into regular vertices. Returns true
// on success, in which case the given DfgAlways was removed from the graph.
bool synthesize(DfgGraph&, DfgAlways*, V3DfgSynthesisContext&, V3DfgAstToDfgContext&,
                size_t& tmpCntr) VL_MT_DISABLED;
