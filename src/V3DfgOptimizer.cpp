...
//     // Expressions considered for extraction as separate assignment to gain more opportunities
//     for
...
//     // List of AstVar nodes read by the visited tree. 'vector' rather than 'set' as duplicates
//     are
...
//         // Replace candidate expressions only reading combinationally driven signals with
//         variables V3UniqueNames names{"__VdfgExtracted"}; for (AstNodeModule* modp =
//         nodep->modulesp(); modp;
...
//                 AstVar* const varp = new AstVar{flp, VVarType::MODULETEMP, name,
//                 cnodep->dtypep()}; varp->trace(false); modp->addStmtsp(varp);
